...
class DecodeBox():
    ...
    def decode_box(self, inputs):
        ...
        for i, input in enumerate(inputs):
            #-----------------------------------------------#
            #   There are three inputs in total, and their shapes are
            ...
            # print(f"Prediction Class : {pred_cls}")
    ...
    def yolo_correct_boxes(self, box_xy, box_wh, input_shape, image_shape, letterbox_image):
        ...
        if letterbox_image:
            #-----------------------------------------------------------------#
            #   The offset calculated here is the offset of the effective area of ​​the image relative to the upper left corner of the image. 
    ...
    def non_max_suppression(self, prediction, num_classes, input_shape, image_shape, letterbox_image, conf_thres=0.5, nms_thres=0.4):
        #----------------------------------------------------------#
        #   Convert the format of the prediction result to the upper left and lower right format.
        ...
        for i, image_pred in enumerate(prediction):
            ...
            print(f"Max confidence: {image_pred[:,4].max().item()}")

            #----------------------------------------------------------#
            #   Using confidence levels for first screening
            #----------------------------------------------------------#
            ...
            #   The content of 7 is: x1, y1, x2, y2, obj_conf, class_conf, class_pred
            #-------------------------------------------------------------------------#
            detections = torch.cat((image_pred[:, :5], class_conf.float(), class_pred.float()), 1)

            #------------------------------------------#
            #   Get all the categories included in the forecast results
            #------------------------------------------#
            ...
            for c in unique_labels:
                #------------------------------------------#
                #   Get all the prediction results after a certain type of score screening
                #------------------------------------------#
                ...
                # # Sort by confidence of the existence of the object
